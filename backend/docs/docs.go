    ...
    "paths": {
        ...
        "/wishlist/toggle": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Toggle Wishlist Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ToggleWishlistRequest"
                        }
                    }
                ],
                "responses": {
...
var SwaggerInfo = &swag.Spec{
	...
	Description:      "This is a sample server for an ecommerce API.",
